...
export DOMAIN="dev.gameofblocks.io";

export K8S_PROJECT="gob"
export K8S_NAMESPACE="gob-feature-${BRANCH_HASH}"
...
if [[ -n "${PRODUCTION+x}" ]]; then
  ...
  export K8S_NAMESPACE="gob"
  #
  export DOMAIN="dev.gameofblocks.io";
  export POSTGRES_DATABASE_gob="gob"
else
  export DOMAIN="${BRANCH_HASH}-${DOMAIN}";
  export POSTGRES_DATABASE_gob="gob_${BRANCH_HASH}"
  #
fi
